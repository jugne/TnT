 ...
 */
/**
 * @author originally Alexandra Gavryushkina, adapted by Ugne Stolz
...
public class SABDSimulator {
	...
	public Node sampledRoot; // the root of the tree
	public Node fullRoot;
	public int sampledNodeNumber;
...
//	public void getHiddenEvents(Node fullTreeSubroot, Node sampledTreeSubroot) {
//		HashSet<String> sampledDonors = getDonors(sampledTreeSubroot);
//		HashSet<String> sampledRecipients = getRecipients(sampledTreeSubroot);
//
//		if (!node.isLeaf()) {
//			if (!node.isFake()) {
//				writer.println(node.getLeft().getID().split("_")[0] + "_" + node.getRight().getID().split("_")[0] + ":"
...
//						+ node.getHeight()));
//			}
//			printTransmissionTimes(node.getLeft());
//			printTransmissionTimes(node.getRight());
//		}
//	}
//
//	private boolean CheckIfHidden(HashSet<String> sampledDonors, HashSet<String> sampledRecipients, Node fullTreeSubroot) {
//		if (!sampledDonors.contains(fullTreeSubroot.getLeft().getID().split("_")[0]) &&
//				sampledRecipients.contains(fullTreeSubroot.getRight().getID().split("_")[0]))
//			return true;
//		return false;
//	}
//
//	public HashSet<String> getDonors(Node subroot) {
//		HashSet<String> donors = new HashSet<>();
//
//		if (!subroot.isLeaf()) {
//			if (!subroot.isFake()) {
//				donors.add(subroot.getLeft().getID().split("_")[0]);
//
////				writer.println(node.getLeft().getID().split("_")[0] + "_" + node.getRight().getID().split("_")[0] + ":"
////						+ (rhoSamplingTime
////								+ node.getHeight()));
//			}
//			getDonors(subroot.getLeft());
//			getDonors(subroot.getRight());
//		}
//		return donors;
//
//	}
//
//	public HashSet<String> getRecipients(Node subroot) {
//		HashSet<String> recipients = new HashSet<>();
//
//		if (!subroot.isLeaf()) {
//			if (!subroot.isFake()) {
//				recipients.add(subroot.getRight().getID().split("_")[0]);
//
////				writer.println(node.getLeft().getID().split("_")[0] + "_" + node.getRight().getID().split("_")[0] + ":"
////						+ (rhoSamplingTime
////								+ node.getHeight()));
