...
public class TnTExchange extends Operator {

	final public Input<Tree> treeInput = new Input<>("transmissionTree",
	...
	public double wide(final Tree tree) {
        ...
        if ((iP != jP) && (i != jP) && (j != iP)
			...
			if (trTreeNodesNoTrOnGenes.contains(iP.getNr())) {
			...
			if (trTreeNodesNoTrOnGenes.contains(jP.getNr())) {
